...
.setColor(0x36393F)
.setDescription(`<a:cryptored:770187639801774080> Sunucu için ayarladığınız erkek rolü başarıyla sıfırlandı!`)
...
.setColor(0x36393F)
.setDescription(`<a:cryptored:770187639801774080> Ayarlayacağınız erkek rolünü belirtiniz!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Crypto`)
...
.setTitle(`${client.user.username} | Erkek rol ayarlama komutu.`)
.setColor(0x36393F)
.setDescription(`<a:cryptoonay:770187690402250772> Erkek rolü başarıyla ${rol} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL)
.setFooter(`Crypto`)
